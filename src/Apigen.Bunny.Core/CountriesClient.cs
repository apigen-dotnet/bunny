...
public partial class CountriesClient
{
  ...
  internal CountriesClient(HttpClient httpClient, ILogger? logger = null)
  {
  ...
  /// </summary>
  public async Task<List<CountryModel>> PublicGetCountryListAsync(CancellationToken cancellationToken = default)
  {
    string url = "country";
    ...
    try
    {
      ...
      List<CountryModel>? result = JsonSerializer.Deserialize<List<CountryModel>>(responseContent, JsonConfig.Default);
