...
public partial class PodsClient
{
  ...
  internal PodsClient(HttpClient httpClient, ILogger? logger = null)
  {
  ...
  /// <summary>
  /// Recreate Pod
  /// Operation: POST /apps/{appId}/pods/{podId}/recreate
  /// </summary>
  public async Task RecreateAsync(string appId, string podId, CancellationToken cancellationToken = default)
  {
    ...
    string url = "apps/{appId}/pods/{podId}/recreate".BuildUrl(pathParams);
