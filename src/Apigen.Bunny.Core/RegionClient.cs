...
public partial class RegionClient
{
  ...
  internal RegionClient(HttpClient httpClient, ILogger? logger = null)
  {
  ...
  /// </summary>
  public async Task<List<RegionModel>> ListAsync(CancellationToken cancellationToken = default)
  {
    string url = "region";
    ...
    try
    {
      ...
      List<RegionModel>? result = JsonSerializer.Deserialize<List<RegionModel>>(responseContent, JsonConfig.Default);
      return result ?? new List<RegionModel>();
    }
