...
public partial class SearchClient
{
  ...
  /// </summary>
  public async Task<SearchResultsModel> ListAsync(SearchPublicGlobalSearchEndpointRequest? request = null, CancellationToken cancellationToken = default)
  {
    ...
    try
    {
      ...
      SearchResultsModel? result = JsonSerializer.Deserialize<SearchResultsModel>(responseContent, JsonConfig.Default);
      return result ?? new SearchResultsModel();
    }
