...
public partial class ApiKeysClient : IApiKeysClient
{
  ...
  /// </summary>
  public async Task<PaginationListModelOfApiKeyModel> PublicGetApiKeysByAccountEndpointAsync(ApiKeyPublicGetApiKeysByAccountEndpointRequest? request = null, CancellationToken cancellationToken = default)
  {
    string url = "apikey".BuildUrl(request: request);
    ...
    try
    {
      ...
      PaginationListModelOfApiKeyModel? result = JsonSerializer.Deserialize<PaginationListModelOfApiKeyModel>(responseContent, JsonConfig.Default);
      return result ?? new PaginationListModelOfApiKeyModel();
    }
